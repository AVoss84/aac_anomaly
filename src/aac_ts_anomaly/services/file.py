...
class XLSXService(AbstractServices):
...
class PickleService(AbstractServices):
...
class YAMLservice(AbstractServices):
...
class TXTService(AbstractServices):
...
class JSONservice(AbstractServices):
...
class TOMLservice(AbstractServices):
