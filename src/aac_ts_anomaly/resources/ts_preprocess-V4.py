...
if periodicity == 52:
    filename = util.get_newest_file(search_for = "AGCS CCO PIC - Notification Counts")    # weekly
if periodicity == 12:
    filename = util.get_newest_file(search_for = "AGCS CCO PIC - Payment Counts")       # monthly
filename
...
df.rename(columns={'Line of Business': 'Lob', 'Source System': 'source_sys'}, inplace=True)
